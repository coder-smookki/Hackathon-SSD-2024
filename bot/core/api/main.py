...
async def main():
    ...
    print(
        await client.create_meeting(
            name_vks="rororororor",
            date_vks="2024-11-25T17:33:00.000000",
            duration_vks=52,
            participants_count_vks=3,
            organizer=organizer,
    ...
    print(
        await client.auth_register(
            login="bobi",
            password="string12343",
            email="bobi@example.com",
            lastName="string12343",
            firstName="string12343",
            middleName="string12343",
            phone="string12343",
            birthday="2024-11-26",
            roleId=5,
        )
