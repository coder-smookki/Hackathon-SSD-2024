...
async def main():
    ...
    print(await client.auth_logout('token'))
    print(await client.autoupdate_token())

    # Получение ВКС для конкретного пользователя
    print(await client.get_user_meetings_by_userid(fromDatetime='2024-10-24T04:32:20.251796', toDatetime='2024-11-28T00:32:20.251836',
                                                   user_id=553))
    ...
    print('\n\n')
    print(await client.create_meeting(name_vks='safasfew14147575', date_vks='2024-11-25T17:33:00.000000',
